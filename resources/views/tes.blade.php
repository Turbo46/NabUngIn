...
<html lang="en">
  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
    ...
    <!--Hero-->
    <main class="max-w-lg bg-white mx-auto p-6 mt-28 rounded-lg">
        <section class="m-10 text-center">
            <h3 class="font-bold text-green-900 text-2xl">Hai, Selamat Datang</h3>
        </section>
        ...
        @endif
        <section class="mt-10">
            <form class="flex flex-col" method="POST" action="/tes">
              @csrf
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label class="block text-gray-700 text-sm font-bold mb-2 ml-3" for="email">Email</label>
                    <input type="email" name="email" id="email" autofocus required class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-green-600 transition duration-500 px-3 pb-3">
                </div>
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label class="block text-gray-700 text-sm font-bold mb-2 ml-3" for="password">Kata Sandi</label>
                    <input type="password" name="password" id="password" required class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-green-600 transition duration-500 px-3 pb-3">
                </div>
                <div class="flex justify-end">
                    <a href="#" class="text-sm text-green-600 hover:text-green-700 hover:underline mb-6">Lupa kata sandi?</a>
                </div>
                <button class="bg-green-900 hover:bg-green-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Masuk</button>
            </form>
        </section>
    </main>

    <div class="max-w-lg mx-auto text-center mt-6 mb-6">
        <p class="text-green-900">Don't have an account? <a href="/regis" class="bg-green-900 text-white p-2 rounded font-bold hover:underline">Sign up</a>.</p>
    </div>
