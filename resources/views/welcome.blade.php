    ...
    <nav id="header" class="fixed w-full z-30 top-0 text-white">
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="block lg:hidden pr-4">
          <button id="nav-toggle" class="flex items-center p-1 text-green-900 hover:text-gray-900 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black rounded-xl p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block py-2 px-4 text-black font-bold no-underline" href="{{ url ('/tes')}}">Layanan</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="/tes">Tentang Kami</a>
            </li>
          </ul>
          <div class="w-full">
            <div class="h-1 mx-auto gradient w-100 opacity-25 my-0 py-0 rounded-t"></div>
          </div>
          @if(Route::has('login'))
          @auth
          <button
      ...
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          ...
          <p class="leading-normal text-2xl mb-8">
            Yuk nabung dan kelola keuanganmu blablabla lalalalla hey
          </p>
          <button class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-3 px-12 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
        ...
        <!--Right Col-->
        <div class="w-full h-25 md:w-3/5 py-1 text-center">
      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full sm:w-1/2 p-6">
             <img class="w-full h-60  md:w-4/5 justify-items-center " src="/img/Group 1936.png" />
          </div>
        </div>
      </div>
        <div class="container max-w-5xl mx-auto m-8 bg-red-50">
          <h1 class="w-full my-2 pt-6 text-5xl font-bold leading-tight text-center text-gray-800">
            Analisis Keuangan
          </h1>
          <div class="w-full mb-4">
            <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
          ...
          <div class="flex flex-wrap">
            ...
            <div class="w-full sm:w-1/2 p-6">
               <img class="w-full h-60  md:w-4/5 justify-items-center " src="/img/Group 1951.png" />
            </div>
          </div>
        </div>
        <div class="container max-w-5xl mx-auto m-8 bg-white">
          <h1 class="w-full my-2 pt-6 text-5xl font-bold leading-tight text-center text-gray-800">
            Catat Pengeluaran
          </h1>
          <div class="w-full mb-4">
